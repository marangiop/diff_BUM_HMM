...
setwd("C:/Users/User/Desktop/diffBUM_HMM results for mature yeast rRNA dataset/version 0.6 - test on mature yeast rRNA dataset/")
...
hist(logdropoffswt$LDR_CT, breaks = 30, main = 'Null distribution of LDRs')
