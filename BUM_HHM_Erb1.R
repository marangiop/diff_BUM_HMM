...
mergedcounts <- read.table("Data/35S_control_Erb1_merged_reads.sgr",comment.char="#",col.names=c("chromosome","position","35S_DMSO_1","35S_DMSO_2","35S_1M7_1","35S_1M7_2"))
mergedstarts <- read.table("Data/35S_control_Erb1_merged_dropoffcounts.sgr",comment.char="#",col.names=c("chromosome","position","35S_DMSO_1","35S_DMSO_2","35S_1M7_1","35S_1M7_2"))
...
write.table(shifted_posteriors,sep="\t",quote=FALSE,file="35S_Erb1_posteriors.txt")
